...
# 10 "../../../Library/StdDriver/src/timer.c"
...
# 11 "../../../Library/StdDriver/src/timer.c" 2
# 39 "../../../Library/StdDriver/src/timer.c"
uint32_t TIMER_Open(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq)
{
...
# 189 "../../../Library/StdDriver/src/timer.c"
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
...
# 217 "../../../Library/StdDriver/src/timer.c"
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
...
# 241 "../../../Library/StdDriver/src/timer.c"
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    uint32_t u32Src, u32Clk;
    const uint32_t au32Clk[] = {0UL, 0UL, 0UL, 0UL, (10000UL), (24000000UL), 0UL, 0UL};
                             ...
                             uint32_t u32EnableInt)
{
    ...
    t = (timer == ((TIMER_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL))) ? ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)) : ((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x11000UL)+ 0x100UL));
...
# 343 "../../../Library/StdDriver/src/timer.c"
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->TRGCTL = (timer->TRGCTL & ~((0x1ul << (1)) | (0x1ul << (2)))) | u32Mask;
}
# 362 "../../../Library/StdDriver/src/timer.c"
...
# 389 "../../../Library/StdDriver/src/timer.c"
int32_t TIMER_ResetCounter(TIMER_T *timer)
{
    uint32_t u32Delay;
