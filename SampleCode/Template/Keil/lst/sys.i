...
# 19 "../../../Library/StdDriver/src/sys.c"
int32_t g_SYS_i32ErrCode = 0;
...
# 132 "../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    ...
    u32TmpAddr = (uint32_t)&((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->IPRST0 + ((u32ModuleIndex >> 24UL));
...
# 162 "../../../Library/StdDriver/src/sys.c"
int32_t SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    uint32_t u32TimeOutCnt = SystemCoreClock * 2;
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->BODCTL & ~((0x1ul << (3)) | (0x7ul << (16)))) |
...
# 195 "../../../Library/StdDriver/src/sys.c"
int32_t SYS_DisableBOD(void)
{
    uint32_t u32TimeOutCnt = SystemCoreClock * 2;
