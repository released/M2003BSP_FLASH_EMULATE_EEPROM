...
int32_t FMC_Erase_SPROM(void)
{
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x22UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = 0x00200000UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0x0055AA03UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x22UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = 0x00200000UL + (0x200);
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0x0055AA03UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
...
# 202 "../../../Library/StdDriver/src/fmc.c"
...
# 247 "../../../Library/StdDriver/src/fmc.c"
...
# 352 "../../../Library/StdDriver/src/fmc.c"
...
# 409 "../../../Library/StdDriver/src/fmc.c"
uint32_t FMC_CheckAllOne(uint32_t u32addr, uint32_t u32count)
{
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS = 0x80UL;
    ...
    i32TimeOutCnt0 = (SystemCoreClock/2);
    while(((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPSTS & (0x1ul << (0)))
    {
        if( i32TimeOutCnt0-- <= 0)
        {
            g_FMC_i32ErrCode = -1;
    ...
    if(g_FMC_i32ErrCode == 0)
    {
        i32TimeOutCnt1 = (SystemCoreClock/2);
        do
        {
        ...
        while( (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0UL) && (g_FMC_i32ErrCode == 0) );
    }

    if( g_FMC_i32ErrCode == 0 )
    {
        if(((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA11FFFFFUL)
            ret = 0xA11FFFFFUL;
        else if(((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA1100000UL)
            ret = 0xA1100000UL;
        else
            g_FMC_i32ErrCode = -1;
    }
