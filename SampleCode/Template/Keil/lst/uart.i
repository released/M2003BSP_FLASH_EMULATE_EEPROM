...
# 80 "../../../Library/StdDriver/src/uart.c"
void UART_Close(UART_T* uart)
{
    uart->INTEN = 0ul;
}
# 95 "../../../Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T* uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 121 "../../../Library/StdDriver/src/uart.c"
void UART_DisableInt(UART_T* uart, uint32_t u32InterruptFlag)
{
...
# 187 "../../../Library/StdDriver/src/uart.c"
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    uint32_t u32UartClkSrcSel, u32UartClkDivNum;
    uint32_t u32ClkTbl[5] = { 0ul, 0ul, 0ul, (24000000UL), 0ul};
    ...
    if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))
    {
        ...
        u32UartClkSrcSel = ((uint32_t)(((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x7ul << (16)))) >> (16);
    ...
    else if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x31000UL)))
    {
        ...
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x7ul << (20))) >> (20);
    ...
    if(u32baudrate != 0ul)
    {
        u32BaudDiv = (((((u32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32baudrate)/2ul)) / (u32baudrate))-2ul);
...
# 261 "../../../Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T* uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
...
# 323 "../../../Library/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T *uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    ...
    if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))
    {
        ...
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x7ul << (16))) >> (16);
...
# 388 "../../../Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T* uart, uint32_t u32TOC)
{
...
# 411 "../../../Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    ...
    if(u32Buadrate != 0ul)
    {
        u32BaudDiv = (((((u32ClkTbl[u32UartClkSrcSel]) / (u32UartClkDivNum + 1ul)) + ((u32Buadrate)*8ul)) / (u32Buadrate) >> 4ul)-2ul);
...
# 489 "../../../Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T* uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 512 "../../../Library/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T* uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32delayno;
    uint32_t u32Exit = 0ul;
...
# 555 "../../../Library/StdDriver/src/uart.c"
void UART_SelectSingleWireMode(UART_T *uart)
{
